...
**Movies that fail the Bechdel test have higher median budgets and median gross totals than ones that pass the Bechdel test.**: 
...
**The most popular movie strategy is to have women but they never talk to each other. Movies that rank as "ok" or passing the test have the lowest median budget and often the lowest median gross totals**: 
...
**The movies that pass the Bechdel test rank the highest for median Return on investment, but also have the greatest IQR.**:
